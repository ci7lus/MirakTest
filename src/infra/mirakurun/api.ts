 ...
 *
 * The version of the OpenAPI document: 3.9.0-beta.1
 *
 *
 ...
 * @enum {string}
 */
export enum ProgramAudiosLangsEnum {
  Jpn = "jpn",
  Eng = "eng",
  Deu = "deu",
  Fra = "fra",
...
export const IptvApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    iptvDiscoverJsonGet: async (options: any = {}): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    iptvLineupJsonGet: async (options: any = {}): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    iptvPlaylistGet: async (options: any = {}): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    iptvXmltvGet: async (options: any = {}): Promise<RequestArgs> => {
...
export class IptvApi extends BaseAPI {
   ...
   * @memberof IptvApi
   */
  public iptvDiscoverJsonGet(options?: any) {
   ...
   * @memberof IptvApi
   */
  public iptvLineupJsonGet(options?: any) {
    return IptvApiFp(this.configuration)
      .iptvLineupJsonGet(options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof IptvApi
   */
  public iptvLineupStatusJsonGet(options?: any) {
    return IptvApiFp(this.configuration)
      .iptvLineupStatusJsonGet(options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof IptvApi
   */
  public iptvPlaylistGet(options?: any) {
    return IptvApiFp(this.configuration)
      .iptvPlaylistGet(options)
      .then((request) => request(this.axios, this.basePath))
  }
   ...
   * @memberof IptvApi
   */
  public iptvXmltvGet(options?: any) {
    return IptvApiFp(this.configuration)
      .iptvXmltvGet(options)
      .then((request) => request(this.axios, this.basePath))
  }
