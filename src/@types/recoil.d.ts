...
declare module "recoil-sync" {
  // https://github.com/facebookexperimental/Recoil/blob/284f9be594db4d62e718334a59c3f5fbe1fd96aa/typescript/refine.d.ts
  export namespace refine {
    ...
    export function union<Checkers extends ReadonlyArray<Checker<unknown>>>(
      ...
      ElementType<{ [K in keyof Checkers]: CheckerResult<Checkers[K]> }>
    >
